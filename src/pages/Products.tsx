  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-24">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold tracking-tight mb-4">Produk Tersedia</h1>
        <p className="text-xl text-zinc-400 mb-8">Pilih layanan untuk mengonfigurasi langganan Anda.</p>
      </div>
